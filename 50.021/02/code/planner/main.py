...
if __name__ == "__main__":
    ...
    # Your code here
    class PlannerProblem(search.Problem):
        def __init__(self, task):
            self.task = task
            super(self.__class__, self).__init__(self.task.initial_state, self.task.goals)
    ...
    prob = PlannerProblem(task)
    result = search.breadth_first_search(prob)
